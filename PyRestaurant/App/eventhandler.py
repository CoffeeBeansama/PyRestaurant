...
class EventHandler(object):
    ...
    def handlePlayerInput():
        ...
        EventHandler.pressingUp = True if EventHandler.keys[pg.K_UP] else False
        EventHandler.pressingDown = True if EventHandler.keys[pg.K_DOWN] else False
        EventHandler.pressingLeft = True if EventHandler.keys[pg.K_LEFT] else False
        EventHandler.pressingRight = True if EventHandler.keys[pg.K_RIGHT] else False
